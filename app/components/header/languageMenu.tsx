...
export function LanguageMenu() {
    ...
    return (
        <div ref={menuRef}className="relative flex items-center">
            <button onClick={() => setLanguageMenuOpen(!MenuOpen)} className="w-full text-left px-6 py-1.5 hover:bg-gray-100 flex items-center gap-3">
                <svg
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 absolute top-20 right-8 z-10 w-220 p-2 text-sm text-gray-900 bg-white rounded-lg shadow-md">
